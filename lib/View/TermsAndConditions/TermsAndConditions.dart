          ...
          child:Column(
            children: [
              InfoCard(
                ...
                description: textLanguage.GetWord("رأفت ستاي هي منصة إلكترونية مملوكة ومطورة من قبل RSK، وهي تطبيق قيد تسجيل براءة اختراع يتيح للمستخدمين حجز الفنادق والمطاعم والفعاليات وغيرها من الخدمات المتوفرة على المنصة. يشير مصطلح \"المستخدم\" إلى أي شخص يستخدم المنصة أو أي من خدماتها."),
              ),
              InfoCard(
                title: textLanguage.GetWord("قبول الشروط"),
                description: textLanguage.GetWord("باستخدام منصة رأفت ستاي، يوافق المستخدم بشكل كامل على جميع الشروط والأحكام المذكورة هنا. في حال عدم الموافقة، يُمنع المستخدم من استخدام المنصة أو أي من خدماتها."),
              ),
              InfoCard(
              ...
              InfoCard(
                ...
                description: textLanguage.GetWord("تحتفظ رأفت ستاي بالحق في تعديل هذه الشروط والأحكام في أي وقت. تصبح جميع التغييرات سارية المفعول فور نشرها داخل المنصة."),
              ),
