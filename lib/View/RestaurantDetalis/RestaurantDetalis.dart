            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                      ...
                      ClipRRect(
                        ...
                        child: CarouselSlider(
                          ...
                          options: CarouselOptions(
                            ...
                            autoPlay: (branches[0]['photos'] as List? ?? []).length > 1,
                  ...
                  SizedBox(height: sizes.GetHeight() * 2),
                  if ((branches[0]['photos'] as List? ?? []).length > 1)
                    Consumer(
                      builder: (context, ref, child) {
                        final currentIndex = ref.watch(RestaurantDetalis_riverpod);
                        return CarouselIndicator(
                          itemCount: (branches[0]['photos'] as List? ?? []).length,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: sizes.GetWidth() * 1),
                                Text("${textLanguage.GetWord("منظر")} ${branches[0]["views_count"] ?? 0}",
                                    style: TextStyle(
                                        color: theme.GetColor("textSecondary"))),
                              ],
                            ),
                            Row(
                              children: [
                                ...
                                SizedBox(width: sizes.GetWidth() * 1),
                                Text("${textLanguage.GetWord("الحجز")} ${branches[0]["bookings_count"] ?? 0}",
                                    style: TextStyle(
                                        color: theme.GetColor("textSecondary"))),
                              ],
                            ),
